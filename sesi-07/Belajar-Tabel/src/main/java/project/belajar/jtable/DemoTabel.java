...
public class DemoTabel{
	...
	private static List<Mahasiswa> sampleData(){
		...
		m1.setNpm("001");
		m1.setNama("Rindah Gustri");
		data.add(m1);
			
		
		Mahasiswa m2 = new Mahasiswa();
		m2.setNpm("002");
		m2.setNama("Firly Nurya Rahim");
		data.add(m2);
		
		
		Mahasiswa m3 = new Mahasiswa();
		m3.setNpm("003");
		m3.setNama("Rini adnriani");
		data.add(m3);
		
		
		Mahasiswa m4 = new Mahasiswa();
		m4.setNpm("004");
		m4.setNama("Lusy Kusuma Wardani");
		data.add(m4);
		
		
		Mahasiswa m5 = new Mahasiswa();
		m5.setNpm("005");
		m5.setNama("Dinun Virza Hanifa");
		data.add(m5);
		
		
		Mahasiswa m6 = new Mahasiswa();
		m6.setNpm("006");
		m6.setNama("Dika Ayu Safitri");
		data.add(m6);
